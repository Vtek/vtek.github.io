...
----
et ajoutez y un fichier user.ts contenant la classe suivante :

++++
<iframe width="100%" height="120" src="//jsfiddle.net/Vtek/m5hp41ot/embedded/" allowfullscreen="allowfullscreen" frameborder="0"></iframe>
++++

Cette classe définit un object de données utilisateur correspondant au JSON qui est renvoyé par l'API.