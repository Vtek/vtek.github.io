...
++++
<iframe width="100%" height="150" src="//jsfiddle.net/Vtek/5vc4fvgx/embedded/js" allowfullscreen="allowfullscreen" frameborder="0"></iframe>
++++
...
++++
<iframe width="100%" height="120" src="//jsfiddle.net/Vtek/m5hp41ot/embedded/js" allowfullscreen="allowfullscreen" frameborder="0"></iframe>
++++
...
++++
<iframe width="100%" height="200" src="//jsfiddle.net/Vtek/s2jgLa0v/embedded/js" allowfullscreen="allowfullscreen" frameborder="0"></iframe>
++++
...
++++
<iframe width="100%" height="90" src="//jsfiddle.net/Vtek/aco04tn1/2/embedded/js" allowfullscreen="allowfullscreen" frameborder="0"></iframe>
++++

Pour manipuler l'objet Http, ajoutez un attribut de classe au dessus du constructeur :

++++
<iframe width="100%" height="80" src="//jsfiddle.net/Vtek/Lu87cq26/embedded/js" allowfullscreen="allowfullscreen" frameborder="0"></iframe>
++++

Dans getUsers() il est maintenant possible d'utiliser la référence pour faire notre appel à l'API :

++++
<iframe width="100%" height="100" src="//jsfiddle.net/Vtek/t6fha4zf/embedded/js" allowfullscreen="allowfullscreen" frameborder="0"></iframe>
++++
...
++++
<iframe width="100%" height="80" src="//jsfiddle.net/Vtek/e6y9jbdk/embedded/js" allowfullscreen="allowfullscreen" frameborder="0"></iframe>
++++
...
++++
<iframe width="100%" height="120" src="//jsfiddle.net/Vtek/g8ho9br1/embedded/js" allowfullscreen="allowfullscreen" frameborder="0"></iframe>
++++

Et pour injecter une instance d'Http, il faut le faire via le constructeur de la classe en décorant le paramètre d'entrée :

++++
<iframe width="100%" height="100" src="//jsfiddle.net/Vtek/kubhg4g1/embedded/js" allowfullscreen="allowfullscreen" frameborder="0"></iframe>
++++
...
++++
<iframe width="100%" height="170" src="//jsfiddle.net/Vtek/Labjf7s5/embedded/html" allowfullscreen="allowfullscreen" frameborder="0"></iframe>
++++

Pour le composant aura pour structure le code suivant :

++++
<iframe width="100%" height="200" src="//jsfiddle.net/Vtek/hjkvya2z/embedded/js" allowfullscreen="allowfullscreen" frameborder="0"></iframe>
++++

Afin que le template puisse fonctionner il faut que le composant dispose d'un attribut public users de type User[] (Le template itère une collection). Avant l'export de la classe il faut donc importer le type User :

++++
<iframe width="100%" height="80" src="//jsfiddle.net/Vtek/ccoLLvu3/embedded/js" allowfullscreen="allowfullscreen" frameborder="0"></iframe>
++++

Ensuite ajoutez avant le constructeur l'attibut correspondant au tableau d'utilisateur :

++++
<iframe width="100%" height="80" src="//jsfiddle.net/Vtek/Lj13hLbp/embedded/js" allowfullscreen="allowfullscreen" frameborder="0"></iframe>
++++
